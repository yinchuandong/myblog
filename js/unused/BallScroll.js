...
$.fn.resumescroll = function(options){
	var opts = $.extend({}, $.fn.resumescroll.defaults, options);
	this.each(function(index, val) {
		var oscroll = {
			...
			percent: $(val).find(".lit-ball").attr("percent"),
			...
			moveReg: function(){
				...
				//linear,ease,ease-in,ease-out,ease-in-out,cubic-bezier(n,n,n,n)	在 cubic-bezier 函数中定义自己的值。可能的值是 0 至 1 之间的数值。规定以相同速度开始至结束的过渡效果（等于 cubic-bezier(0,0,1,1)）。
